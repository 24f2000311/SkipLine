        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#for-organizers" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                For Organizers
              </a>
              <a href="#for-customers" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                For Customers
              </a>
            </nav>
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link href="/login" className="text-sm font-medium text-foreground hover:text-sl-blue transition-colors">
                Log in
              </Link>
              <Link href="/register" className="inline-flex items-center justify-center h-10 px-6 rounded-full bg-sl-blue text-white font-semibold tracking-[-0.01em] text-sm hover:bg-blue-700 transition-standard shadow-sm">
                Create an Event
              </Link>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-[100%] left-0 w-full bg-white dark:bg-background border-b border-border shadow-lg animate-sl-fade-in">
            <div className="px-4 py-6 flex flex-col gap-4">
              ...
              <Link href="/register" className="inline-flex items-center justify-center h-12 w-full mt-2 rounded-lg bg-sl-blue text-white font-semibold tracking-[-0.01em] text-base shadow-sm">
                Create an Event
              </Link>
            </div>
          </div>
        ...
        <section className="relative w-full max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
            ...
            <div className="flex flex-col space-y-6 text-center lg:text-left z-10 w-full lg:w-[50%]">
              <div className="inline-flex items-center mx-auto lg:mx-0 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-sl-blue text-[11px] font-semibold tracking-[0.08em] uppercase border border-blue-100 dark:border-blue-800/50 w-max">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-lg mx-auto lg:mx-0 font-normal">
                Skip the physical line. Join digitally, keep moving, and know exactly when it's your turn.
              </p>
              
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-2 justify-center lg:justify-start">
                <Link href="/register" className="w-full sm:w-auto inline-flex items-center justify-center h-12 px-8 rounded-lg bg-sl-blue text-white font-semibold tracking-[-0.01em] text-base hover:bg-blue-700 hover:shadow-lg transition-all hover:-translate-y-0.5">
                  Create an Event
                </Link>
                <a href="#how-it-works" className="w-full sm:w-auto inline-flex items-center justify-center h-12 px-8 rounded-lg bg-white dark:bg-slate-800 text-foreground border border-border font-semibold tracking-[-0.01em] text-base hover:bg-muted transition-colors shadow-sm">
                  See How It Works
            ...
            <div className="relative w-full lg:w-[45%] h-[500px] flex items-center justify-center lg:justify-end mt-10 lg:mt-0 hidden sm:flex">
              ...
              <div className="absolute right-0 lg:-right-8 top-16 p-4 bg-white dark:bg-slate-800 border border-emerald-100 dark:border-emerald-900/50 shadow-xl rounded-2xl z-20 animate-[sl-float_5s_ease-in-out_infinite_reverse]">
                <div className="flex flex-col items-center gap-1">
                  <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-semibold uppercase tracking-[0.08em] rounded-full mb-1">You're Up!</span>
                  <p className="text-3xl font-extrabold tabular-nums text-foreground tracking-tight">A24</p>
              ...
              <div className="absolute right-12 bottom-24 p-2 px-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur border border-border shadow-md rounded-xl z-0 scale-90">
                <p className="text-xs font-semibold tabular-nums text-slate-400">A26 <span className="font-normal text-[10px]">Position 3</span></p>
              </div>
              <div className="absolute right-32 bottom-32 p-2 px-3 bg-white/60 dark:bg-slate-800/60 backdrop-blur border border-border shadow-md rounded-xl z-0 scale-75">
                <p className="text-xs font-semibold tabular-nums text-slate-400">A25 <span className="font-normal text-[10px]">Position 2</span></p>
              </div>
                  ...
                  <div className="flex-1 flex flex-col items-center relative overflow-hidden bg-white dark:bg-slate-950">
                    ...
                    <div className="absolute inset-0 pt-8 pb-6 px-4 flex flex-col items-center opacity-0 animate-[sl-screen-2_12s_infinite]">
                      ...
                      <div className="w-full flex-1 flex flex-col pt-4">
                        <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-[0.08em] text-center mb-1">Tech Fest 2026</p>
                        <h2 className="text-2xl font-bold tracking-tight text-foreground text-center mb-6">Food Truck Line</h2>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-2xl border border-border space-y-4 mb-6">
                          <div className="flex justify-between text-sm font-semibold">
                            ...
                            <span className="text-sl-blue tabular-nums">3</span>
                          </div>
                          <div className="flex justify-between text-sm font-semibold">
                            <span>Est. time</span>
                            <span className="text-sl-blue tabular-nums">12 min</span>
                          </div>
                        </div>

                        <div className="w-full h-12 bg-sl-blue rounded-xl flex items-center justify-center text-white font-semibold tracking-[-0.01em] text-sm shadow-md transition-transform scale-95 origin-center">
                          Join Queue
                        </div>
                      </div>
                      <div className="mt-auto flex gap-1.5 pt-4">
                    ...
                    <div className="absolute inset-0 pt-8 pb-6 px-4 flex flex-col items-center opacity-0 animate-[sl-screen-3_12s_infinite]">
                      ...
                      <div className="w-full bg-blue-50 dark:bg-slate-900 border border-blue-100 dark:border-slate-800 rounded-3xl p-5 flex flex-col items-center shadow-sm relative overflow-hidden mb-4">
                        <p className="text-[11px] font-semibold text-sl-blue uppercase tracking-[0.08em] mb-2">You're in the queue!</p>
                        <h2 className="text-6xl font-extrabold tabular-nums text-sl-dark tracking-tight mb-4">A27</h2>
                        <p className="text-sm font-bold text-foreground">Position 4</p>
                        <p className="text-xs font-medium text-muted-foreground mt-1 tabular-nums">Est. wait ~ 12 min</p>

                        <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-100">
                          <div className="h-full bg-sl-blue w-1/4 rounded-r-full" />
                        </div>
                      </div>
                      <p className="text-[10px] text-center text-muted-foreground px-2 font-normal">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-emerald-500 to-emerald-600 text-white opacity-0 animate-[sl-screen-4_12s_infinite] pt-6">
                      ...
                      <span className="px-3 py-1 bg-white/20 rounded-full text-[11px] font-semibold uppercase tracking-[0.08em] mb-4">
                        It's your turn
                      </span>
                      <h2 className="text-6xl font-extrabold tabular-nums tracking-tight mb-2 text-white">A27</h2>
            ...
            <div className="bg-white dark:bg-slate-900 border border-border shadow-sm rounded-3xl p-8 md:p-12">
              <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                <div className="text-center md:text-left">
                  <h2 className="text-[11px] font-semibold tracking-[0.08em] text-sl-blue uppercase mb-1">How It Works</h2>
                  <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Four simple steps. Zero lines.</h3>
                </div>
                ...
                {[
                  ...
                  <div key={s.step} className="flex flex-col items-center text-center relative z-10 w-full md:w-1/4 px-2 mb-8 md:mb-0">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-900/30 text-sl-blue text-[10px] font-semibold tabular-nums flex items-center justify-center border border-blue-100 dark:border-blue-800">
                        {s.step}
                      </span>
                    ...
                    <h4 className="text-lg font-bold tracking-tight text-foreground mb-1">{s.title}</h4>
                    <p className="text-muted-foreground text-sm leading-snug font-normal">{s.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="w-full lg:w-2/5 p-8 rounded-3xl bg-red-50/50 dark:bg-red-950/10 border border-red-100 dark:border-red-900/30 relative">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h4 className="font-bold tracking-tight text-slate-900 dark:text-slate-100 text-lg">The old way</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400 font-normal">Standing in line. Wasting time.</p>
                  </div>
              ...
              <div className="w-full lg:w-1/5 text-center flex flex-col items-center">
                <h3 className="text-xl font-bold tracking-tight text-foreground mb-2">The difference is clear.</h3>
                <p className="text-sm text-muted-foreground font-normal">Your place is saved.<br/>You don't have to be.</p>
              ...
              <div className="w-full lg:w-2/5 p-8 rounded-3xl bg-emerald-50/50 dark:bg-emerald-950/10 border border-emerald-100 dark:border-emerald-900/30 relative">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h4 className="font-bold tracking-tight text-sl-blue text-lg">With Skipline</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400 font-normal">Join digitally. Keep moving.</p>
                  </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white dark:bg-slate-900 border border-border shadow-sm rounded-3xl p-8 md:p-10 flex flex-col justify-between h-full">
                <div className="mb-8">
                  <h2 className="text-[11px] font-semibold tracking-[0.08em] text-sl-blue uppercase mb-2">For Organizers</h2>
                  <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground mb-3">Total control, in minutes.</h3>
                ...
                <div className="bg-slate-50 dark:bg-slate-950 rounded-xl border border-border p-4 w-full max-w-sm mx-auto shadow-sm">
                  <div className="flex justify-between items-center mb-4 pb-2 border-b border-border">
                    <div className="flex items-center gap-2 font-semibold text-sm"><Users className="h-4 w-4" /> Live Queue</div>
                    <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-semibold uppercase tracking-[0.08em] rounded">OPEN</span>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center p-2 border border-border rounded bg-white dark:bg-slate-900 shadow-sm">
                      <div>
                        <p className="font-semibold text-sm tabular-nums">A24</p>
                        <p className="text-[10px] text-muted-foreground tabular-nums">Waiting: 2m</p>
                      </div>
                      <button className="px-3 py-1 bg-sl-blue text-white text-xs font-semibold tracking-[-0.01em] rounded">Call Next</button>
                    </div>
                    <div className="flex justify-between items-center p-2 border border-border rounded opacity-60">
                      <div>
                        <p className="font-semibold text-sm tabular-nums">A25</p>
                        <p className="text-[10px] text-muted-foreground tabular-nums">Waiting: 5m</p>
                      </div>
                    ...
                    <div className="flex justify-between items-center p-2 border border-border rounded opacity-40">
                      <div>
                        <p className="font-semibold text-sm tabular-nums">A26</p>
                        <p className="text-[10px] text-muted-foreground tabular-nums">Waiting: 8m</p>
                      </div>
                      <span className="text-[10px] font-medium text-slate-500">In Line</span>
                    </div>
                  </div>
              ...
              <div id="for-customers" className="bg-white dark:bg-slate-900 border border-border shadow-sm rounded-3xl p-8 md:p-10 flex flex-col justify-between h-full">
                <div className="mb-8">
                  <h2 className="text-[11px] font-semibold tracking-[0.08em] text-cyan-600 dark:text-cyan-400 uppercase mb-2">For Customers</h2>
                  <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground mb-3">Join instantly. No app needed.</h3>
                  <p className="text-muted-foreground text-sm font-normal">
                ...
                <div className="bg-slate-50 dark:bg-slate-950 rounded-xl border border-border p-4 w-full max-w-[200px] mx-auto shadow-sm flex flex-col items-center text-center">
                  ...
                  <span className="text-[10px] font-semibold text-emerald-600 uppercase tracking-[0.08em] mb-1">You're Up!</span>
                  <h4 className="text-4xl font-extrabold tabular-nums tracking-tight text-foreground mb-2">A24</h4>
        ...
        <section className="py-8">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 border-y border-border py-6">
              <h4 className="text-sm font-semibold tracking-tight text-foreground shrink-0">Built for real events</h4>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="bg-sl-blue rounded-[2rem] p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10 text-center md:text-left">
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-2">Ready to move people forward?</h2>
                <p className="text-blue-100 text-lg font-normal">Create your first event and experience a simpler way to manage queues.</p>
              </div>

              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 shrink-0">
                <Link href="/register" className="inline-flex items-center justify-center h-12 px-8 rounded-lg bg-white text-sl-blue font-semibold tracking-[-0.01em] text-base hover:bg-slate-50 transition-colors shadow-sm w-full sm:w-auto">
                  Create an Event
                </Link>
                <Link href="/login" className="inline-flex items-center justify-center h-12 px-8 rounded-lg bg-blue-700 text-white border border-blue-600 font-semibold tracking-[-0.01em] text-base hover:bg-blue-800 transition-colors w-full sm:w-auto">
                  Log in
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
            ...
            <div className="flex flex-col gap-3">
              <SkiplineLogo size="sm" />
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-[0.08em] mt-1">
